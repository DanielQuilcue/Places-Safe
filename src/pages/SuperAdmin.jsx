...
export default function SuperAdmin() {
  ...
  const onSubmit = handleSubmit(async (userAdmin) => {
    userAdmin.userId = user.id;
    signupAdmin(userAdmin);
  ...
  // if (isAuthenticated) {
  //   navigate("/form"); // Redirige si el usuario ya está autenticado
  //   return null; // No renderiza nada si el usuario ya está autenticado
  // }
          ...
          <div className="p-12 bg-white mx-auto rounded-3xl w-96">
            <div className="mb-7">
              ...
              <p className="text-gray-400">
                ...
                <span className="text-sm text-blue-700 hover:text-blue-700 ">
                  dashboard
                </span>
              </p>
            </div>
              ...
              <form onSubmit={onSubmit}>
                <div className="relative mb-3">
                  <input
                    ...
                    type="text"
                    placeholder="Nombre"
                    {...register("superAdminUsername", { required: true })}
                  />
                  {errors.email && (
                    <p className="text-blue-700 ">Nombre requerido</p>
                  )}
                </div>
                <div className="relative mb-3">
                  <input
                    ...
                    type="text"
                    placeholder="Correo"
                    {...register("superAdminEmail", { required: true })}
                  />
                  {errors.email && (
                ...
                <div className="relative mb-3">
                  <input
                    ...
                    {...register("superAdminPassword", { required: true })}
                  />
                  {errors.password && (
