              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <div className="md:col-span-2 lg:col-span-1">
                  <div className="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div>
                      <h5 className="text-xl text-gray-700 text-center uppercase">
                        Ingresos al conjunto
                      </h5>
                      ...
                      <span className="block text-center text-gray-500 text-ls ">
                        Comparado con la semana pasada $13.988
                      </span>
                    </div>
                    <table className="w-full text-gray-600">
                      <tbody>
                        <tr>
                          <td className="py-2">Carros</td>
                ...
                <div>
                  <div className="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                    <h5 className="text-xl text-gray-700 uppercase text-center">
                      Parqueadero
                    </h5>
                    <div className="my-5">
                      ...
                      <span className="text-gray-500">
                        Comparado con la semana pasada 14%
                      </span>
                    </div>
                    <svg
                      className="w-full"
                    ...
                    <table className="mt-6 -mb-2 w-full text-gray-600">
                      <tbody>
                        <tr>
                          <td className="py-2">Propietarios de Carros</td>
                          <td className="text-gray-500">896</td>
                          <td>
                            <svg
                              className="w-16 ml-auto"
                        ...
                        <tr>
                          <td className="py-2">Propietarios de Motos</td>
                          <td className="text-gray-500">1200</td>
                          <td>
                            <svg
                              className="w-16 ml-auto"
                ...
                <div>
                  <div className="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div className="mt-6">
                      <h5 className="text-xl text-gray-700 text-center uppercase">
                        uso del parqueadero por tiempo
                      </h5>
                      <div className="mt-2 flex justify-center gap-4">
                        <h3 className="text-3xl font-bold text-gray-700">
                          28H
                      ...
                      <span className="block text-center text-gray-500">
                        Comparado con la semana pasada 13H
                      </span>
                    </div>
                    <table className="mt-6 -mb-2 w-full text-gray-600">
                      <tbody>
