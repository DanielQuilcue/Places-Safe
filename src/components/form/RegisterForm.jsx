  ...
  return (
    <>
      <div className="space-y-6">
        {/* {loading && ( // Mostrar el spinner solo cuando se está enviando el formulario y loading es true
          <div className="flex justify-center">
            <div className="animate-spin h-6 w-6 text-purple-700" />
          </div>
        )} */}
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="relative mb-3 ">
            ...
            />
            {errors.email && <p className="text-blue-500">Correo requerido</p>}
          </div>
          ...
          <div className="relative mb-3 ">
            ...
            />
            {errors.password && (
              <p className="text-blue-500">Contraseña requerida</p>
            )}
            <div
